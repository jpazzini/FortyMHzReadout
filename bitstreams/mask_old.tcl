...
set_property PROBES.FILE {/home/xdaq/bitstreams/tdc_gbt_old.ltx} [get_hw_devices xc7vx485t_0]
set_property FULL_PROBES.FILE {/home/xdaq/bitstreams/tdc_gbt_old.ltx} [get_hw_devices xc7vx485t_0]
refresh_hw_device [lindex [get_hw_devices xc7vx485t_0] 0]
set_property OUTPUT_VALUE $mask [get_hw_probes tdc_i/mask -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx485t_0] -filter {CELL_NAME=~"tdc_i/vio_i"}]]
