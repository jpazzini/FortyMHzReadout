...
set_property OUTPUT_VALUE $mask [get_hw_probes no_event -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx485t_0] -filter {CELL_NAME=~"vio"}]]
commit_hw_vio [get_hw_probes {no_event} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx485t_0] -filter {CELL_NAME=~"vio"}]]
