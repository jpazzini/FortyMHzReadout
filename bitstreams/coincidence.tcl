...
set_property OUTPUT_VALUE $mask [get_hw_probes tdc_i/coincidence -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx485t_0] -filter {CELL_NAME=~"tdc_i/vio_i"}]]
